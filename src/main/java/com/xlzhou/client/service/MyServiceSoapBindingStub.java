...
public class MyServiceSoapBindingStub extends org.apache.axis.client.Stub implements IService {
    ...
    public String getStr(String arg0) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://service.server.xlzhou.com/", "getStr"));
